    ...
    def get_parent_topic(self, topic_name):
        ...
        if (doc_id):
            ...
            if(len(results_list)>0):
                ...
                print("Cuurently we don't have any sub topic for {}".format(topic_name))
...
if __name__=="__main__":
    ...
    graph_api_h.set_env_variables(  
                                    ...
                                    graph_name="Machine_Learning_Concepts",\
                                    database_name="Data_Science"
                                )
    
    #graph_api_h.get_parent_topic(topic_name="Matrix completion")

    #graph_api_h.get_all_sub_topics(topic_name="A brief review of probability theory")

    graph_api_h.get_all_other_sub_topics_of_a_topic(topic_name="Quantiles")