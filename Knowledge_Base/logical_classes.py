...
class Fact(object):
    ...
    def __init__(self, statement, supported_by=[]):
        ...
        self.asserted = not supported_by # self.asserted =True -> supported_by = []
        #self.supported_by = supported_by
        self.supported_by = []
        self.supports_facts = []
        self.supports_rules = []
        for pair in supported_by:           #Adding all the pairs that we think will support the fact.
...
class Rule(object):
    ...
    def __init__(self, rule, supported_by=[]):
        ...
        self.asserted = not supported_by  ##boolean flag indicating if rule was asserted instead of inferred from other facts and rules in the KB
        self.supported_by = []
        self.supports_facts = []
        self.supports_rules = []
...
class Bindings(object):
    ...
    def bound_to(self, variable):
        #Variable = Constant('bing')
        #Variable.element = 'bing'
    ...
    def test_and_bind(self, variable_term, value_term):
        #Variable Term = Term(Constant('bing'))
        #Variable Term.Term  = Constant('bing')
        #Value_term = Term(Constant('ada'))
        #Value_term.Term = Constant('ada')
        ...
        #bound = Variable(value) or Constant(value)
        if bound:
